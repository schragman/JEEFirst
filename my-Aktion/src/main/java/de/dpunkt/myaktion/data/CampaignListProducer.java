...
import de.dpunkt.myaktion.model.*;
...
public class CampaignListProducer implements Serializable {
	...
	public List<Campaign> createMockCampaigns() {
		...
		donation1.setAccount(new Account(donation1.getDonorName(),"XXX Bank", "DE44786543210000123456"));
		
		Donation donation2 = new Donation();
		donation2.setDonorName("Karl Meyer");
		donation2.setAmount(30d);
		donation2.setReceiptRequested(false);
		donation2.setStatus(Status.IN_PROCESS);
		donation2.setAccount(new Account(donation1.getDonorName(),"YYY Bank", "DE44564564321000123456"));
